  ...
  return (
      ...
      <div className="container py-3 selecting-box">
        <form className="row justify-content-center">
          <select
            className="form-select film-box mt-1 col-5 col-sm-5 col-md-3"
          ...
          <select
            className="form-select theatre-box mt-1 col-5 col-sm-5  col-md-2"
            aria-label="Default select example"
          ...
          <select
            id="dateBox"
            className="form-select date-box mt-1 col-5 col-sm-5 col-md-2"
            aria-label="Default select example"
          ...
          <select
            id="timeBox"
            className="form-select time-box mt-1 col-5 col-sm-5 col-md-2"
            aria-label="Default select example"
