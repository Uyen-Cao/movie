      ...
      <footer>
        <div className="row my-5 justify-content-center py-5">
          <div className="col-11">
            ...
            <div className="row ">
              <div className="col-xl-4 col-md-4 col-sm-4 col-auto my-md-0 mt-5 order-sm-1 order-3 align-self-end">
              ...
              <div className="col-xl-4 col-md-4 col-sm-4 col-auto order-1 align-self-end ">
              ...
              <div className="col-xl-4 col-md-4 col-sm-4 col-auto order-2 align-self-end mt-3 ">
